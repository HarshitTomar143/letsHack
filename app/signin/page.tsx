            ...
            <form className="flex flex-col gap-4">
              ...
              <div className="flex items-center bg-[#231B3A] rounded-lg px-4 py-3 mb-2 relative">
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 p-1 text-white/70 hover:text-white cursor-pointer"
                  tabIndex={-1}
              ...
              <button
                type="submit"
                className="mt-4 w-full py-3 rounded-lg bg-gradient-to-r from-[#A259FF] to-[#4BC6EF] text-white font-semibold text-lg transition-all hover:opacity-90 cursor-pointer"
              >
                Login
              </button>
            </form>
